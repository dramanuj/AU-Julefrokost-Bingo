...
$(document).ready(function() {
	...
	for (i=0; i<24; i++)	{
		...
		if (i==12) {
			$('#board').append("<div data-value='1' class='selected freesquare' id='sqfree'><div class='text'><br/>Gl&#230delig Julefrokost!</div></div>");
	...
	$('div.square').tappable(function () {
      ...
      if ($(this).data('value') == 1) {
		...
		if (row1 == 5 || row2 == 5 || row3 == 5 || row4 == 5 || row5 == 5 || col1 == 5 || col2 == 5 || col3 == 5  || col4 == 5  || col5 == 5 || diag1 == 5 || diag2 == 5) {
			$('#header').html(winText);
			$('#header').addClass("win");
        if (boolWinSndPlayed == false){
					winSnd.play();
					boolWinSndPlayed = true;
				}
      ...
      boolWinSndPlayed = false;
		};

		if (row1 == 5 & row2 == 5 & row3 == 5 & row4 == 5 & row5 == 5 & col1 == 5 & col2 == 5 & col3 == 5  & col4 == 5  & col5 == 5 & diag1 == 5 & diag2 == 5) {
			$('#header').html(fullWinText);
			$('#header').addClass("fullhouse");
